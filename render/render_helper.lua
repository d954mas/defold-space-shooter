...
function M.action_to_position(action)
	...
	position.x=M.clamp(position.x,0,M.world_width)
	position.y=M.clamp(position.y,0,M.world_height)
	return position
end

function M.updateWorld(world_width,world_height,viewport_x,viewport_y,viewport_width,viewport_height)
